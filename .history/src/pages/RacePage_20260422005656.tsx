...
const STORY_BEATS = [
  ...
  { year: 2016, text: 'SpaceX lands the Falcon 9 first stage at sea. The reuse era begins.' },
  { year: 2018, text: 'China reaches 39 launches in a single year, overtaking Russia for the second-place slot.' },
  { year: 2020, text: 'SpaceX reusable fleet scales dramatically: 26 launches, with 22 flying reused hardware.' },
      ...
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          ...
          <h1 className={styles.title}>
            ...
            <span className={styles.titleSub}>2000&ndash;2025</span>
          </h1>
        ...
        {/* About button + panel — outside and above the chart box */}
            ...
            <div className={styles.aboutLegend}>
              {(['USA', 'Russia', 'China', 'Europe', 'Japan', 'India', 'SpaceX', 'Other'] as CountryKey[]).map(c => (
                <div key={c} className={styles.aboutLegendItem}>
                  <span className={styles.aboutLegendDot} style={{ background: COUNTRY_HEX[c] }} />
        ...
        <div className={styles.cta}>
					<Link to="/detail" className={styles.ctaLink}>
