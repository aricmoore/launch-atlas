    ...
    bars.forEach(bar => {
      ...
      if (defs.select(`#${id}`).empty()) {
        ...
        grad.append('stop').attr('offset', '50%')
          .attr('stop-color', hex).attr('stop-opacity', '0.82')
        grad.append('stop').attr('offset', '85%')
          .attr('stop-color', hex).attr('stop-opacity', '0.55')
        grad.append('stop').attr('offset', '100%')
          .attr('stop-color', '#111111').attr('stop-opacity', '0.70')
      }
