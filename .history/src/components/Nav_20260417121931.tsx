...
function ApogeeIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
      style={{ flexShrink: 0, display: 'block', minWidth: '28px' }}
    >
  ...
  return (
    ...
    >
      ...
      <text
        ...
        fontSize="40" fontWeight="500" letterSpacing="1" fill="#f4f4f5"
      >LAUNCH</text>
      <text
        x="210" y="36"
        fontFamily="'IBM Plex Mono', 'Courier New', monospace"
        fontSize="40" fontWeight="500" letterSpacing="1" fill="#60a5fa"
      >ATLAS</text>
    </svg>
  )
}
